    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html"><span class="fw-bolder text-info">Portofolio</span></a>
        ...
        <header class="py-0">
            <div class="container px-5 pb-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-6 my-auto">
                        <!-- Header text content-->
                        <div class="text-center text-xxl-start ">
                            <h1 class="display-3 fw-bolder mb-2" data-aos="fade-up" data-aos-duration="1000"
                                data-aos-delay="200"><span class="text-gradient d-inline">Tito
                                    Rizki Purnomo</span></h1>
                            <div class="fs-3 fw-light text-muted mb-2">
                                <p></p>
                            </div>
                    ...
                    <div class="col-xxl-6">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="assets/profile.png" alt="..." height="4000px" />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="mx-auto">
                        <div class="small m-0 text-center">Copyright &copy; Portofolio Tito Rizki</div>
                    </div>
                </div>
            </div>
        </footer>
